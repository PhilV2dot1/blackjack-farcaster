  ...
  return (
    <div className="flex flex-wrap gap-2 sm:gap-3 justify-center mt-3 sm:mt-6">
      ...
      {showNewGameButton && (
        <button
          onClick={onNewGame}
          className="px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-celo-yellow to-yellow-400 hover:from-yellow-400 hover:to-yellow-500 text-gray-900 rounded-xl font-bold text-base sm:text-lg shadow-lg transition-all transform hover:scale-105 active:scale-95 min-w-[120px] sm:min-w-[140px]"
          style={{
      ...
      {showOnChainButton && (
        <button
          ...
          disabled={disabled}
          className="px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-celo-yellow to-yellow-400 hover:from-yellow-400 hover:to-yellow-500 text-gray-900 rounded-xl font-bold text-base sm:text-lg shadow-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all transform hover:scale-105 active:scale-95 min-w-[140px] sm:min-w-[160px]"
          style={{
