...
export async function shareBlackjackResult(
  ...
  const text = `I just played Blackjack on Celo!\n\n${emojis[outcome]} ${messages[outcome]}\n\nStats: ${stats.wins}W / ${stats.losses}L / ${stats.pushes}P\nBlackjacks: ${stats.blackjacks}\n\nPlay now:`;
